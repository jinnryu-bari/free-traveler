...
'여행 Gallery'는 SCR-002 화면의 UI_CONTRACT.md 주요 Component 목록에 정의된 조각을 구현하는 Component Task다. Page Owner Task(`DATA-REPRESENTATIVE` 중 PAGE-* 항목)가 이 Task의 산출물을 조립한다.
...
- `design-reference/D-001/DESIGN.md` §3 Typography, §17 Section 계층
...
- 최소 8장, 실제 장소·구도를 설명하는 alt 문장, 출처/작가 캡션, `next/image` responsive+lazy load

## Visual AC

- Desktop 3열, Mobile 2열
...
- Functional AC의 각 조건을 개별 케이스로 분리해 확인한다: 최소 8장, 실제 장소·구도를 설명하는 alt 문장, 출처/작가 캡션, `next/image` responsive+lazy load
