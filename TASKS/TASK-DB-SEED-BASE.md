...
- E2E/RLS 테스트에 필요한 최소 사용자 3역할(Adult Member/Moderator/Admin)·동행글·신고 샘플 데이터
...
- Seed 데이터는 실제 개인정보 미포함(가상 데이터만)

## Test Cases

- Functional AC의 각 조건을 개별 케이스로 분리해 확인한다: E2E/RLS 테스트에 필요한 최소 사용자 3역할(Adult Member/Moderator/Admin)·동행글·신고 샘플 데이터
