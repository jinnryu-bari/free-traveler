...
'여행 Timeline'는 SCR-002 화면의 UI_CONTRACT.md 주요 Component 목록에 정의된 조각을 구현하는 Component Task다. Page Owner Task(`DATA-REPRESENTATIVE` 중 PAGE-* 항목)가 이 Task의 산출물을 조립한다.
...
- 최소 6개 항목, 각 연도·장소명·1문장 요약

## Visual AC

- Desktop 세로 타임라인, Mobile 폭만 축소
...
- Functional AC의 각 조건을 개별 케이스로 분리해 확인한다: 최소 6개 항목, 각 연도·장소명·1문장 요약
