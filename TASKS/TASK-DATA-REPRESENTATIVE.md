...
'대표 소개 정적 데이터'는 콘텐츠를 `src/data/` 정적 TypeScript 데이터로 관리하는 Data Task다(`docs/PROJECT_SCOPE.md` §2 원칙 — CMS 없음). 이 데이터는 관련 Component/Page Owner Task가 읽기 전용으로 소비한다.
...
- 대표명·`50+ Trips`·`30+ Countries`(단일 소스, 홈/대표 페이지 공통 참조), 소개문·철학, 방문 국가 30개↑(권역 포함), Timeline 6개↑, Gallery 8장↑(alt/출처/작가/라이선스), 문의/SNS 링크
...
- Functional AC의 각 조건을 개별 케이스로 분리해 확인한다: 대표명·`50+ Trips`·`30+ Countries`(단일 소스, 홈/대표 페이지 공통 참조), 소개문·철학, 방문 국가 30개↑(권역 포함), Timeline 6개↑, Gallery 8장↑(alt/출처/작가/라이선스), 문의/SNS 링크
