# MANUAL-RESPONSIVE-VISUAL — Desktop/Mobile 시각·리듬 점검
...
'Desktop/Mobile 시각·리듬 점검'는 자동화하지 않고 수동 점검·체크리스트 서명으로 완료를 기록하는 Task다(`docs/PROJECT_SCOPE.md` §2 최종 확인 규칙).
...
- 1440px/390px 육안 확인: Hero 높이 규칙(다음 Section 일부 노출), Section 패턴 반복 금지 리듬, 카드 그리드 1열 Mobile 전환, 빈 여백·Placeholder 문구 부재
