# RELEASE-SUPABASE-CHECK — Supabase 프로젝트·RLS·Auth 확인
...
'Supabase 프로젝트·RLS·Auth 확인'는 배포 전 최종 게이트를 확인하는 Task다 — 병합/배포 이전에 반드시 통과해야 한다.
...
- 운영 프로젝트에서도 6개 테이블 전부 RLS 활성 상태 확인, CSRF/SameSite 쿠키 기본 설정 확인
