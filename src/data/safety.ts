...
export const countrySafetyInfo: CountrySafety[] = [
  {
    ...
    scopeText: "전역",
    categories: {
      security: "전반적으로 치안이 우수하나 관광지·번화가에서는 소매치기에 유의하세요.",
      scam: "길거리 호객 바(캐치바)를 통한 바가지 요금 피해 사례가 있으니 주의하세요.",
      law: "공공장소 흡연이 엄격히 제한되며 지정 흡연구역만 이용해야 합니다.",
      transport: "대중교통이 정확하고 안전하나 러시아워 혼잡도가 매우 높습니다.",
      disasterClimate: "지진·태풍이 빈번하니 숙소의 대피 안내를 사전에 확인하세요.",
      health: "의료 수준이 높으나 여행자보험 가입과 해외진료 가능 병원 확인을 권장합니다.",
      cultureDressCode: "사원·신사 방문 시 정숙을 유지하고 노출이 심한 복장은 자제하세요.",
      emergencyContacts: "경찰 110 · 구급/화재 119 · 주일본 대한민국대사관 +81-3-3452-7611",
    },
  ...
  },
  {
    ...
    categories: {
      security: "방콕·치앙마이 등 주요 관광지는 안전하나 남부 국경지역은 여행을 자제해야 합니다.",
      scam: "보석·투어 사기, 미터기 조작 택시 요금 사기 사례가 흔하니 주의하세요.",
      law: "왕실을 모독하는 언행은 중대 범죄로 처벌되며, 대마초는 여전히 규제 대상입니다.",
      transport: "툭툭·택시 이용 시 사전에 요금을 협의하거나 그랩(Grab) 앱 이용을 권장합니다.",
      disasterClimate: "우기(6~10월)에는 홍수·집중호우에 대비해야 합니다.",
      health: "뎅기열 등 모기 매개 감염병 예방을 위해 방충 대책이 필요합니다.",
      cultureDressCode: "사원 방문 시 어깨·무릎을 가리는 복장을 갖추고 신발을 벗어야 합니다.",
      emergencyContacts: "관광경찰 1155 · 응급 1669 · 주태국 대한민국대사관 +66-2-481-6000",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      cultureDressCode: "종교시설 방문 시 어깨·무릎을 가리는 복장이 필요합니다.",
      emergencyContacts: "경찰 17 · 응급 112 · 주프랑스 대한민국대사관 +33-1-4753-6996",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      emergencyContacts: "경찰 113 · 응급 112 · 주이탈리아 대한민국대사관 +39-06-802-461",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      health: "의료 수준이 높으며 여행자보험 가입을 권장합니다.",
      cultureDressCode: "성당 방문 시 어깨·무릎을 가리는 복장이 필요합니다.",
      emergencyContacts: "경찰 091 · 응급 112 · 주스페인 대한민국대사관 +34-91-353-2000",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      health: "의료 수준이 높으며 여행자보험 가입을 권장합니다.",
      cultureDressCode: "특별한 복장 제한은 없으나 왕실 관련 시설은 격식을 갖추세요.",
      emergencyContacts: "경찰/응급 999 또는 112 · 주영국 대한민국대사관 +44-20-7227-5500",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      security: "대도시 일부 지역은 야간 치안이 취약하니 이동 경로를 사전에 확인하세요.",
      scam: "렌터카·주차장 소지품 절도, 전화 금융사기에 주의하세요.",
      law: "주(state)별로 법규가 상이하며 총기 관련 규정도 다릅니다.",
      transport: "대중교통보다 렌터카 의존도가 높은 도시가 많습니다.",
      disasterClimate: "지역에 따라 허리케인·산불·폭설 위험이 있으니 기상특보를 확인하세요.",
      health: "의료비가 매우 높으니 여행자보험 가입이 필수적입니다.",
      cultureDressCode: "특별한 복장 제한은 없으나 종교시설 방문 시 예의를 갖추세요.",
      emergencyContacts: "경찰/응급 911 · 주미국 대한민국대사관 +1-202-939-5600",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    scopeText: "전역",
    categories: {
      security: "전반적으로 치안이 우수하나 번화가 야간 음주 소란에 유의하세요.",
      ...
      emergencyContacts: "경찰/응급 000 · 주호주 대한민국대사관 +61-2-6270-4100",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      cultureDressCode: "특별한 복장 제한은 없습니다.",
      emergencyContacts: "경찰/응급 111 · 주뉴질랜드 대한민국대사관 +64-4-473-9073",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      transport: "산악열차·케이블카 이용 시 기상 상황에 따른 운행 중단에 대비하세요.",
      disasterClimate: "산악지역 눈사태·낙석 위험이 있으니 등산로 통제 안내를 확인하세요.",
      health: "의료 수준이 매우 높으나 비용이 높으니 여행자보험이 필요합니다.",
      cultureDressCode: "특별한 복장 제한은 없습니다.",
      emergencyContacts: "경찰 117 · 응급 144 · 주스위스 대한민국대사관 +41-31-356-2444",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    scopeText: "전역",
    categories: {
      security: "전반적으로 치안이 우수하나 대도시 축제 기간 소매치기에 유의하세요.",
      scam: "가짜 티켓 판매, 노점 기부금 사기에 주의하세요.",
      law: "나치 관련 상징물 전시·경례는 형사 처벌 대상입니다.",
      transport: "아우토반은 구간에 따라 속도 제한이 없으니 운전 시 주의가 필요합니다.",
      disasterClimate: "겨울철 폭설·결빙 도로에 대비하세요.",
      health: "의료 수준이 높으며 여행자보험 가입을 권장합니다.",
      cultureDressCode: "특별한 복장 제한은 없습니다.",
      emergencyContacts: "경찰 110 · 응급 112 · 주독일 대한민국대사관 +49-30-260-650",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      cultureDressCode: "수도원·성당 방문 시 어깨·무릎을 가리는 복장이 필요합니다.",
      emergencyContacts: "경찰 100 · 응급 166 · 주그리스 대한민국대사관 +30-210-698-4080",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    categories: {
      ...
      health: "의료 수준이 양호하며 여행자보험 가입을 권장합니다.",
      cultureDressCode: "성당 방문 시 어깨·무릎을 가리는 복장이 필요합니다.",
      emergencyContacts: "경찰/응급 112 · 주포르투갈 대한민국대사관 +351-21-793-7515",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
  ...
  },
  {
    ...
    scopeText: "전역",
    categories: {
      security: "전반적으로 안전하나 프라하 구시가지 소매치기·바가지 식당에 유의하세요.",
      scam: "환전소 불리한 환율, 레스토랑 계산서 조작 사기에 주의하세요.",
      law: "대중교통·박물관 무임입장 적발 시 벌금이 부과됩니다.",
      transport: "트램·지하철이 안전하고 편리하나 표를 반드시 검표기에 태그해야 합니다.",
      disasterClimate: "겨울철 결빙 도로·적설에 대비하세요.",
      health: "의료 수준이 양호하며 여행자보험 가입을 권장합니다.",
      cultureDressCode: "특별한 복장 제한은 없습니다.",
      emergencyContacts: "경찰 158 · 응급 112 · 주체코 대한민국대사관 +420-234-090-411",
    },
    sourceName: SOURCE_NAME,
    sourceUrl: SOURCE_URL,
    lastCheckedAt: LAST_CHECKED,
