...
const STEPS = [
  {
    step: "①",
    title: "조건에 맞는 글 찾기",
    body: "국가·지역·기간·모집 상태로 필터링해 원하는 동행글을 찾습니다.",
  },
  {
    step: "②",
    title: "참가 메시지 보내기",
    body: "간단한 소개와 함께 비공개 참가 메시지를 작성자에게 보냅니다.",
  },
  {
    step: "③",
    title: "작성자 승인 기다리기",
    body: "작성자가 메시지를 확인하고 승인하면 동행이 시작됩니다.",
  },
];
    ...
    <section className="mx-auto max-w-[1240px] px-5 py-16 lg:px-10 lg:py-20">
      ...
      <div className="border-hairline mt-6 flex flex-col gap-3 rounded-md border p-5 lg:flex-row lg:items-center lg:justify-between">
        <p className="text-body-md text-ink">
          <strong>안전한 만남을 위해:</strong> 연락처·SNS 아이디 등 개인 정보는
          이 화면 어디에도 공개로 남기지 마세요. 불편한 상대는 언제든 신고하거나
          차단할 수 있습니다.
        </p>
        <Link
