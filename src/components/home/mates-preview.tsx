...
export async function MatesPreview() {
  ...
  return (
    <section
      id={MATES_PREVIEW_SECTION_ID}
      className="mx-auto flex max-w-[1240px] flex-col gap-6 px-5 py-16 scroll-mt-20 lg:px-10 lg:py-20"
    >
      <div>
      ...
      {preview.length === 0 ? (
        <div className="border-hairline flex flex-col items-start gap-3 rounded-md border p-8">
          <p className="text-body-md text-body">
            아직 등록된 동행글이 없어요. 첫 동행글을 올려 함께 떠날 사람을
            찾아보세요.
          </p>
          <Link
            href="/travel-tools"
