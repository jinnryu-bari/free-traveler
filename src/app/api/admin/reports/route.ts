...
async function requireModeratorOrAdmin(): Promise<
...
export async function GET(request: Request) {
  ...
  const parsedStatus = statusFilterSchema.safeParse(
...
export async function PATCH(request: Request) {
  ...
  const report = await updateReportStatus(parsed.data.reportId, {
